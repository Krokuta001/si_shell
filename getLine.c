...
/**
 * get_input - Read a line from input (excluding the newline character).
 * @info: Parameter struct.
 *
 * Return: The number of bytes read.
 */
 ...
 *
 * Return: The number of bytes read (usually stored in 'r').
 */
 ...
 *
 * Return: The string containing the read line (s).
 */
...
/**
 * sigintHandler - Handles and blocks Ctrl-C (SIGINT).
 * @sig_num: The signal number (SIGINT).
 *
